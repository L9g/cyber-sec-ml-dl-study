...
> 范围：项目一主数据集 = **NetFlow-v2 统一系列**（Sarhan et al. 标准化的 43 特征
> NF-UNSW-NB15-v2 / NF-ToN-IoT-v2 / NF-CSE-CIC-IDS2018-v2 / NF-BoT-IoT-v2 / NF-UQ-NIDS-v2）。
...
8. **【强化+挑战·新角度】真正的鸿沟也许是"合成 vs 真实世界"，而非"合成 A vs 合成 B"（B5, JISA 2024, UQ 团队）。**
   ...
   **对项目一的双刃**：(a) 强化"benchmark 虚高"主框架；(b) **挑战**——项目一只在合成 NF-v2 内部做诚实评估
   （A≠B 跨数据集），并未触及"整组合成 benchmark 可能都偏离真实网络"这一更深层问题。这是 portfolio
